                ...
                <div class="socials">
                    {#each member.socials as social}
                        ...
                        {#if social.includes('artstation')}
                            <a href="{social}" target="_blank">
                                <i class="fa-brands fa-artstation"></i>                            </a>
                        {/if}
                        {#if social.includes('bento')}
                            <a href="{social}" target="_blank">
                                <i class="fa-brands fa-artstation"></i>                            </a>
                        {/if}
                        ...
                        {/if}
                        {#if social.includes('anirudhchaturvedi.me') || social.includes('aayushgarg.net') || social.includes('vercel')}
                            <a href="{social}" target="_blank">
